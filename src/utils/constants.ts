...
export const PACKAGE_ID_V0 = process.env.NEXT_PUBLIC_PACKAGE_ID_V0;
export const PACKAGE_ID_V1 = process.env.NEXT_PUBLIC_PACKAGE_ID_V1;
...
// FRENS POOL
export const FRENS_STAKING_POOL_ID = process.env.NEXT_PUBLIC_FRENS_STAKING_POOL_ID;
export const FRENS_STAKING_POOL_POINTS_TABLE_ID = process.env.NEXT_PUBLIC_FRENS_STAKING_POOL_POINTS_TABLE_ID;
