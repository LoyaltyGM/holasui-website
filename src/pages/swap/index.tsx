...
import {HistoryP2PDialog} from "../../components/Dialog/HistoryP2PDialog";

const font_montserrat = Montserrat({subsets: ["latin"]});
const font_montserrat_white = Montserrat({subsets: ["latin"]});
        ...
        >
            <>
                <div className="md:mt-20 mt-4 md:mb-0 mb-4 flex justify-between">
                    ...
                    <button
                        className="w-32  font-bold rounded-lg border-2 border-yellowColor text-yellowColor hover:bg-yellowColor hover:text-white py-4"
                ...
                <div
                    ...
                    <div className="w-full items-center gap-1 md:flex justify-between mb-2">
                                ...
                                >
                                    {creatorObjectIds?.map((fren) => {
                                        return (
                                            ...
                                            >
                                                <Image src={fren.url} alt="collection_img" width={90} height={130}
                                                       className="mt-1"/>
                                            </div>
                                        );
                                    })}
                        ...
                        <div className="md:w-1/2 w-full px-3">
                            ...
                            >
                                <button
                                    className="bg-yellowColor content-center items-center rounded-md font-bold text-white w-full flex justify-between px-3 py-2">
                                    <p>You Recieve</p>
                                    <ChevronDownIcon className="h-5 w-5 "/>
                                </button>
                                <div>
                                    ...
                                    >
                                        ...
                                        {recipientCoinAmount !== 0 && recipientCoinAmount !== null ? (
                                            <div
                                                className="text-2xl text-center border bg-white  flex items-center justify-center rounded-md">{`+${recipientCoinAmount} SUI`}</div>
                                        ) : (
                                            <></>
                                        )}
                                    </div>
