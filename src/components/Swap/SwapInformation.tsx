...
export const SwapInformation = ({
    ...
    return (
        <div className="md:w-full w-full px-3 md:mb-0 mb-2 ">
            <div
                className="h-[45vh] md:h-[30vh] mb-2 flex flex-col cursor-pointer justify-between w-full py-2 px-2 font-normal border-2 rounded-lg bg-white border-lightGrayColor text-purpleColor"
            ...
            >
                ...
                >
                    {coinAmount !== 0 && coinAmount !== null ? (
                        <div
                            className="text-2xl text-center gap-2 w-24 h-24 border bg-white flex items-center justify-center rounded-md">
                    ...
                    {userObjectIds?.map((object) => {
                        return (
                            ...
                            >
                                <Image src={object.url} alt="collection_img" width={90} height={90}
                                       className="mt-1"/>
                            </div>
                        );
                    })}
                ...
                <div className="flex justify-center text-center content-center items-center">
                    <button
                        className={classNames(" text-center content-center items-center rounded-md font-medium text-white w-full flex justify-between px-3 py-2",
                            isRecipient ? "bg-redColor" : "bg-purpleColor")}>
            ...
            <LabeledInput>
                <div className="relative">
                    <div
                        className="pointer-events-none border-lightGrayColor absolute inset-y-0 left-0 flex items-center pl-3 pr-3">
                        <Image src={ImageSuiToken} alt="token" className="h-[25px] w-[26px]" aria-hidden="true"/>
                    </div>
                    <input
                        type={"text"}
                        name="sui_amount"
                        className={"input-field border-lightGrayColor w-full pl-12 bg-white"}
